function [ps,pf]=MOGWO_ForCEC2020(N,M_Iter,LB,UB,Dim,nRep,CostFunction)
...
Archive_size=nRep;   % Repository Size
...
for i=1:GreyWolves_num
    ...
    GreyWolves(i).Cost=feval(CostFunction, GreyWolves(i).Position);
